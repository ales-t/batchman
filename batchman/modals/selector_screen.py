...
class SelectorScreen(ModalScreen):
    ...
    def __init__(self, prompt_text: str, getter_fn: callable, on_submit_callback: callable, *args, **kwargs):
    ...
    def compose(self) -> ComposeResult:
        yield Vertical(
            ...
            OptionList(*natsorted(self.getter_fn()), id="selector"),
            HorizontalGroup(
    ...
    def on_option_list_option_selected(self, event: OptionList.OptionSelected) -> None:
        ...
        self.app.pop_screen()
        self.submit_callback(self.selected)
